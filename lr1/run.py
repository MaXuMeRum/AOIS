...
div_result_bin = divide_binary(x1_bin, x2_bin)
div_result_decimall = binary_to_dec(div_result_bin)
div_result_decimal = x1 / x2
print(f"\nРезультат деления (в 10-ом формате): {div_result_decimal}")
print(f"Прямой код: {div_result_bin}")
print(f"Обратный код: {to_reverse_binary(div_result_decimall)}")
print(f"Дополнительный код: {to_additional_binary(div_result_decimall)}")
